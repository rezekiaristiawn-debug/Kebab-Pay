  ...
  return (
    <div className="h-dvh flex flex-col bg-gray-50 overflow-hidden">
      <header className="flex-none z-10 bg-white border-b border-gray-200 pt-[env(safe-area-inset-top)]">
        <div className="flex items-center justify-between gap-2 p-1.5 sm:p-2 px-3 sm:px-4">
          <div className="flex items-center gap-2 shrink-0">
            ...
            <div className="flex flex-col leading-none">
              <span className="text-2xl font-bold text-black leading-tight">Kebab</span>
              <span className="text-2xl font-bold text-black leading-tight">Gatsu</span>
            </div>
          </div>
            ...
            {navItems.map((item) => {
              ...
              return (
                <button
                  ...
                  title={item.label}
                  className={`flex items-center justify-center px-2.5 py-0.5 transition-colors cursor-pointer ${
